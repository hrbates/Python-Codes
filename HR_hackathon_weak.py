...
plt.plot(teff1/pow(10,9),Lum1/pow(10,51), Label = r'$\rho_0$ = $5 \times 10^8$ g/cc')
plt.plot(teff2/pow(10,9),Lum2/pow(10,51), Label = r'$\rho_0 = 10^9$ g/cc')
plt.plot(teff3/pow(10,9),Lum3/pow(10,51), Label = r'$\rho_0 = 3 \times 10^9$ g/cc')
plt.plot(teff4/pow(10,9),Lum4/pow(10,51), Label = r'$\rho_0 = 5 \times 10^9$ g/cc')
plt.plot(teff5/pow(10,9),Lum5/pow(10,51), Label = r'$\rho_0 = 9 \times 10^9$ g/cc')

plt.xscale('log')
plt.yscale('log')
plt.xlabel(r'$T_9$')
plt.ylabel('Log L (ergs s$^{-1}$)')
plt.axis([15,1.e-8,1.e-20,20])
